...
export class Slice extends React.Component<SliceProps, SliceState> {
    ...
    public getAnglePoint(startAngle: number, endAngle: number, radius: number, x: number, y: number) {
        var x1, y1, x2, y2;
    ...
    draw(s: number) {
        ...
        var p = this.props, path = [], a, b, c, self = this, step: number;
